...
# Dependencies
apt-get install -y git fakeroot build-essential ncurses-dev xz-utils libssl-dev bc liblz4-tool kernel-package gcc-4.9-plugin-dev gcc-5-plugin-dev ca-certificates wget kexec-tools
